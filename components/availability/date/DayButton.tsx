    ...
    <button
      ...
      className={twMerge(
        clsx(
          ...
          props.className,
          {
            "font-semibold bg-slate-800  text-slate-100 hocus:border-black hocus:shadow-sm hocus:shadow-gray-800 hocus:-mt-0.5 hocus:z-10 hocus:mb-0.5 border border-transparent":
              !isDisabled,
            "bg-gray-900 text-gray-300": isDisabled,
