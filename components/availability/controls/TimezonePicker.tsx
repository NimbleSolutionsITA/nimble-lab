  ...
  return (
    <div className="flex-grow">
      ...
      <select
        ...
        id="location"
        name="location"
        className="mt-1 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-white bg-gray-800 ring-1 ring-inset ring-gray-900 focus:ring-2 focus:ring-accent-300 sm:text-sm sm:leading-6 overflow-x-clip"
        onChange={(e) => {
          dispatch({
            type: "SET_TIMEZONE",
