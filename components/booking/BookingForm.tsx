...
export default function BookingForm() {
  ...
  return (
    <Modal
      ...
      <form
        className="mt-3 sm:mt-0 sm:ml-4 text-white"
        onSubmit={(event) => {
          ...
          <div className="isolate -space-y-px rounded-md shadow-sm">
            <div className="relative rounded-md rounded-b-none px-3 pt-2.5 pb-1.5 ring-1 ring-inset ring-gray-700 focus-within:z-10 focus-within:ring-2 focus-within:ring-accent-600">
              ...
              <input
                ...
                name="name"
                id="name"
                className="block w-full border-0 p-0 text-white placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 bg-gray-900"
            ...
            <div className="relative rounded-md rounded-t-none px-3 pt-2.5 pb-1.5 ring-1 ring-inset ring-gray-700 focus-within:z-10 focus-within:ring-2 focus-within:ring-accent-600">
              ...
              <input
                ...
                id="email"
                className="block w-full border-0 p-0 text-white placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 bg-gray-900"
                placeholder="mrossi@gmail.com"
              />
            </div>
          </div>
          <div>
            <p className="text-sm font-medium">In che modo desideri effettuare l&apos;incontro?</p>
                ...
                {locations.map((location) => (
                  <div key={location.value} className="flex items-center">
                    ...
                    <label
                      ...
                      className="ml-1.5 block text-sm leading-6 text-white">
                      {location.name}
                    </label>
                  </div>
                ))}
